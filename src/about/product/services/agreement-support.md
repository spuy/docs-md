...
Actualizaciones:   ERPCYA   pondrá   a   disposición   del   CLIENTE   las   nuevas   versiones   y/o actualizaciones del Software (aplica solamente para Adempiere como un servicio en la nube), de forma que las aplicaciones estén siempre al día y con las máximas prestaciones.
...
3.3. El precio del Servicio se incrementará con el IVA (o impuestos que procedan) legalmente aplicable y podrá ser revalorizado anualmente, en el mes de inicio de cada año.  ERPCYA comunicará por escrito al CLIENTE dichas variaciones.
