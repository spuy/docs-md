...
- [Objetivo Principal y Sustentación](object)
- [Ejecución](execution)
- [Préstamo](loan)
- [Generar Seleccion de Pago](selection)
- [Generar Pagos de Préstamo](loan-payment)
- [Generar Factura desde Préstamo](generate-invoice)