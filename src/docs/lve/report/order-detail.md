...
![check transacción de ventas del reporte detalle de la orden](/assets/img/docs/lve/report/resources/check-sales-transaction-of-the-order-detail-report.png)
