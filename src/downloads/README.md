...
Obtenga más información sobre Solop ERP [aquí](../docs)

:::

## ¿Dónde está disponible Solop ERP?

Tenemos muchas formas de descargar Solop ERP, puede usar la forma que más le convenga o se adapte a sus necesidades para ciclos de prueba, control de calidad o entornos de producción.
...
[**Liberaciones de Github**](https://github.com/erpya/zk-ui/releases) es el centro de muchas aplicaciones de código abierto y permite compartir código fuente, lanzamientos; Realice acciones para construir proyectos automáticamente. Tenemos todos los repositorios de la comunidad Solop ERP sobre él. Ver más al respecto [aquí](binary.md).


**Liberaciones de ERPyA** son todas las versiones soportadas por [Solop ERP](https://solopsoftware.com/). Ver más al respecto [aquí](updates.md).