...
- Problemas con tipo de referencia para actualizador de ADempiere

## Detalle Técnico

- Core-Tools: Add support to Payroll closing
- Update-Management: Fixed error with Action value
