...
- Se agrega servicio para cierre de caja desde la nueva ui de ADempiere

## Correcciones

- Cambio menor en localización Venezuela

## Detalle Técnico

- LVE: Cambio menor
- adempiere-gRPC-Server:
  - Add support to cash closing
  - Fixed error with dictionary field names
