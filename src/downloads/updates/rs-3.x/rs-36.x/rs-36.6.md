...
- Se agrega unidad de medida de conversión para exportar catálogo
- Se agrega opciones por defecto para usuarios en el terminal asociado
...
- adempiere-gRPC-Server: Add default support to seller allocation
- CST-STD: Add export for product catalog
