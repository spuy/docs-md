...
**Fecha de Liberación:** 2022-01-28
...
- Validación por punto nulo al momento de ejecutar un reporte sin formato de exportación por defecto

## Detalle Técnico

- CST-STD: Validate NPE for Server Scheduler

## Soporte a Versiones

- ADempiereBase: Versión de Liberación: 3.9.3-rs-4.3
- CST-STD: Versión de Liberación: rs-31.1
