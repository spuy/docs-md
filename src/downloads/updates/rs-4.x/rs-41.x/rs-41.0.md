...
- Ahora se puede predeterminar el tipo de documento para los cierres de cajas generados desde el punto de ventas
...
- Point-Of-Sales-Improvements: Add suppor to default document type for cash closing
...
- Aplicar los XML's:
  - Point-Of-Sales-Improvements:
    - 09720_Add_Default_Cash_Closing_for_POS.xml
