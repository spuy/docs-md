...
- Corrección de problema con el código de cliente en la cuenta bancaria para el TXT del banco de Venezuela

## Detalle Técnico

- LVE: Corrección de problema con el código de cliente en la cuenta bancaria para el TXT del banco de Venezuela
