...
- Corrección de error en tiempo de ejecución para procesos que abren ventanas de manera automática desde el ZK

## Detalle Técnico

- CST-STD:
  
  - Fixed error with Null Pointer for open result
