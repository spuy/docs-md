...
- Se corrige la cantidad de débitos en el TXT de pago detallado del banco Banesco

## Detalle Técnico

- Corrección de cantidad de débitos totales en el TXT detallado del banco Banesco
