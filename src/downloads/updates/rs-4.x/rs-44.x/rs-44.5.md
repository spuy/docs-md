...
- Se implementa exportación de catálogo para tiendas usando un método genérico no atado a plataforma
- Cambio menor en la cola de tienda

## Detalle Técnico

- CST-STD:
  
  - Implement generic export catalog from e-Commerce

- e-Commerce-Queue::

  - Rename changes class
