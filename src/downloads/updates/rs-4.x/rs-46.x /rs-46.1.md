...
**Fecha de Liberación:** 2022-05-31

## Novedades

- Se Corrige Metodo para guardar Referencias desde Documento Origen

## Detalle Técnico

- Withholding:

  - Fix Method to copy values from source document
  
- LVE-AdditionalTax:
  
  - Support to Copy DateAcct from Cash/Payment
