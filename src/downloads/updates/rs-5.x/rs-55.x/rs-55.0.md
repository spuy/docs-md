...
**Fecha de Liberación:** 2023-06-27

## Novedades

- Se incorpora una librería genérica independiente para el manejo de monto en letras de iReport

- Se corrige problema con monto en letras para monto sin decimales

## Contexto

- Reportes de iReport
- Reportes que lleven monto en letras
