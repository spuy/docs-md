...
**Fecha de Liberación:** 2023-06-29

## Novedades

- Se corrige problemas con monto en letras para valores enteros
...
- Fixed error with decimal point for amount in words
