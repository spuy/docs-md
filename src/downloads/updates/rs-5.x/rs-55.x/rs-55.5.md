...
**Fecha de Liberación:** 2023-07-11

## Novedades

- Se agrega soporte para que el filtro de órdenes de ventas sea por la columna **Actualizado** en lugar de la columna **Fecha de Orden**.

## Contexto

- Órdenes de Venta

- Proceso automático para cierre de órdenes de venta
...
- Add support to updated field for close sales orders
