...
**Fecha de Liberación:** 2023-07-19

## Novedades

- Correccion en Estado de Cuentas por Elemento Contable
- Correccion en Calculo de Monto Acumulado al Reversar Documento de Costos Adicionales

## Contexto

- Estado de Cuentas por Elemento Contable
- Motor de Costos
...
- Fix Accumulated Amount at Reversed Landed Cost Allocation
- Add method for get where clause from parameter tree with table alias
- Fix Fin Statement By Element Filter
...
- Farmer-Assistance-Program: 1.5.6
