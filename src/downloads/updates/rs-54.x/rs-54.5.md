...
**Fecha de Liberación:** 2023-05-31

## Novedades

  - Se corrige problema al buscar facturaas completamente pagadas con anticipos de otros períodos en comisiones

## Contexto

- Ventas:
  - Al Procesar Comisiones
  - Para tipo de comisión personalizada totalmente pagada

## Enlaces Relacionados

- [Calculo de Comisiones #344](https://github.com/erpcya/Control-FPLE/issues/344)
...
- CST-STD:
  - [Add Support to replace warehouse to on Record Weight](https://github.com/erpcya/Control-FPLE/issues/344)
