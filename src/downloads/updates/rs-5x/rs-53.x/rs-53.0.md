...
## Novedades
 ...
 - Correccion de error en en seleccion de Smart Browse
  - Correccion de error en transaccion de Creacion de Tipo de Conversion Automaticamente
## Contexto

- Todas las Ventanas inteligentes
...
- CST-STD:
  ...
  - Fix Current Selection on Smart Browse

- Currency-Convert-Documents:

  - Fix bug with transaction at create conversion type
