...
- Se agrega soporte a Columna de Peso y Volumen en Entidad de Productos en Aplicacón Movil
- Se Agrega soporte a Columna de Nota de Despacho en Aplicación Movil
  
## Contexto

Fuerza de Ventas Movil-e

## Enlaces Relacionados

- [Control FPLE](https://github.com/erpcya/Control-FPLE/issues/433)
...
- CST-STD:
  - Remove printing for shipment generate from Outbound Orders
